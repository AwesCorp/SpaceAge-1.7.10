...
public class BlockConnectedGlasses extends BlockGlass {
	...
	public static IIcon[] texturesClear = new IIcon[47];
	...
	public static IIcon[] texturesBlue = new IIcon[47];

	public BlockConnectedGlasses(Material material) {
	...
	public boolean matchBlockIdAndMeta(IBlockAccess world, int x, int y, int z, int meta) {
		return world.getBlock(x, y, z) == SpaceAgeCore.tintedGlass && world.getBlockMetadata(x, y, z) == meta;
	}
