...
public class BlockOres1 extends Block { 
	...
	public BlockOres1(Material material) {
		super(material);
   ...
   /* @SideOnly(Side.CLIENT)
	...
	public IIcon getIcon(int par1, int par2) {
		switch(par2) {
			case 0:
				if(this.worldObj.provider.dimensionId == SpaceAgePlanets.instance.vulcanID) {
					return icons[0];
				} else if(this.worldObj.provider.dimensionId == SpaceAgePlanets.instance.edenID) {
					return icons[1];
				}
				return icons[0];
			case 1:
			...
			case 9:
				return icons[11];
			case 10:
				if(this.worldObj.provider.dimensionId == SpaceAgePlanets.instance.ontarineID) {
					return icons[12];
				} else if(this.worldObj.provider.dimensionId == SpaceAgePlanets.instance.hadesID) {
					return icons[13];
				}
				return icons[12];
			case 11:
