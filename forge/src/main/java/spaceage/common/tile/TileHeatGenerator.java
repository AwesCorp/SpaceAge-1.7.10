...
public class TileHeatGenerator extends TileElectricInventoryNetworked implements IFluidHandler, FluidGuiHelper {
	...
	public void updateEntity() {
		...
		boolean powered = ((worldObj.getBlock(xCoord, yCoord - 1, zCoord) == Blocks.lava) || (worldObj.getBlockId(xCoord, yCoord - 1, zCoord) == Blocks.fire)) && (creatingSteam == true);
    ...
    {
    	boolean powered = (worldObj.getBlock(xCoord, yCoord - 1, zCoord) == Block.lavaStill.blockID) && (creatingSteam == true);
        return powered == true;
    }
