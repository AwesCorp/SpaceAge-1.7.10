...
/*	public static final Configuration config = new Configuration(new File("config/AwesCorp/SpaceAgeCore.cfg"));
	...
	public void doStuffPreviouslyInInit(FMLPreInitializationEvent event) {
		...
		spaceshipAlloyMeta = new BlockSpaceshipAlloy(Material.rock).setBlockName("spaceshipAlloy");
		...
		tintedGlass = new BlockConnectedGlasses(Material.glass).setBlockName("reinforcedGlass").setCreativeTab(tabSA);
		
		coral = new BlockCoral(Material.ground).setBlockName("coral").setCreativeTab(tabSA);
		
		//Machines
		metaGenerator = new BlockGenerator(UniversalElectricity.machine).setBlockName("metaGenerator").setCreativeTab(tabSA);
		tank = new BlockTank(Material.iron).setBlockName("tank").setCreativeTab(tabSA);
		cable = new BlockCable(UniversalElectricity.machine).setBlockName("spaceAgeCable").setCreativeTab(tabSA);
	...
	//CRAFTING
		//TOOLS
		removeCraftingRecipe(new ItemStack(Items.diamond_pickaxe, 1));
		removeCraftingRecipe(new ItemStack(Items.diamond_hoe, 1));
		removeCraftingRecipe(new ItemStack(Items.diamond_shovel, 1));
		removeCraftingRecipe(new ItemStack(Items.diamond_axe, 1));
		removeCraftingRecipe(new ItemStack(Items.diamond_sword, 1));
		
		//ARMOUR
		removeCraftingRecipe(new ItemStack(Items.diamond_helmet, 1));
		removeCraftingRecipe(new ItemStack(Items.diamond_chestplate, 1));
		removeCraftingRecipe(new ItemStack(Items.diamond_leggings, 1));
		removeCraftingRecipe(new ItemStack(Items.diamond_boots, 1));
		
		//Tile Entities
		removeCraftingRecipe(new ItemStack(Items.brewing_stand, 1));
		removeCraftingRecipe(new ItemStack(Blocks.enchanting_table, 1));
