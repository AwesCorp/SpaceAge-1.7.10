                    ...
                    for (int y = j1; y <= i2; ++y) {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D) {
                            for (int z = k1; z <= j2; ++z) {
                                ...
                                if(d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (par1World.getBlock(x, y, z) == this.blockToReplace) && (par1World.getBlockMetadata(x, y, z) == this.blockToReplaceMetadata)) {
                                    par1World.setBlock(x, y, z, this.minableBlock, minableBlockMetadata, 2);
                                }
                            }
                        }
                    }
